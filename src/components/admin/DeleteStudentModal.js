...
const DeleteStudentModal = ({ studentName, studentId, onClose, onDelete }) => {
  const handleDelete = () => {
    onDelete(studentId);
  };
  ...
  return (
    <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center">
      <div className="bg-white rounded-lg shadow-lg w-96 p-6 relative">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Supprimer un étudiant</h2>
        <p className="text-gray-700 mb-4">
          Êtes-vous sûr de vouloir supprimer l'étudiant <span className="font-bold">{studentName}</span> ?
        </p>
