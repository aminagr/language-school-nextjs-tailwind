      ...
      <div className="flex flex-wrap justify-center mb-6 space-x-2 sm:space-x-4">
        {days.map((day) => (
          <button
            ...
            className={`w-full sm:w-auto px-6 py-2 text-lg font-medium ${activeTab === day ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-600'} rounded-lg transition duration-300 mb-2 sm:mb-0`}
          >
